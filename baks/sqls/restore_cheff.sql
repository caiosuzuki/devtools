...
RESTORE DATABASE [CheffEscolar] FROM  DISK = N'/home/caio/devtools/baks/cheffEscolarModelo.bak' WITH  FILE = 1,  MOVE N'CheffEscolar' TO N'/var/opt/mssql/data/CheffEscolar.mdf',  MOVE N'CheffEscolar_log' TO N'/var/opt/mssql/data/CheffEscolar_log.ldf',  NOUNLOAD,  REPLACE,  STATS = 5
